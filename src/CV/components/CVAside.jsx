import { Box, Typography, LinearProgress, Link, makeStyles, useTheme } from '@material-ui/core';
...
const CVAside = ({ photo, skills, contacts }) => {
  ...
  return (
    <Box p={1} className={classes.aside} component="aside" mr={1} bgcolor={theme.palette.grey[300]}>
            ...
            {contacts.map((contact) => (
              <Box component="li" key={contact.name}>
                <Box display="flex" alignItems="center">
                  ...
                  <Box mr={1}><ContactIcon name={contact.name} /></Box>
                  {contact.value && (
